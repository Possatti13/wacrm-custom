...
describe("mondayIndex", () => {
  it("maps Monday → 0 and Sunday → 6", () => {
    expect(mondayIndex(new Date(2026, 4, 18))).toBe(0); // Mon (2026-05-18)
    expect(mondayIndex(new Date(2026, 4, 19))).toBe(1); // Tue (2026-05-19)
    expect(mondayIndex(new Date(2026, 4, 23))).toBe(5); // Sat (2026-05-23)
    expect(mondayIndex(new Date(2026, 4, 24))).toBe(6); // Sun (2026-05-24)
  });
